...
async function createWaitingForReviewMessage(
  interaction,
  charInfo,
  verifiedAccount,
  improvementInput,
  ...
  if (charInfo == null) {
    ...
    if (charInfo.dataValues.twoVtwoRating != null) {
      let n = `\n\n__2v2:${noBreakSpace.repeat()}**${
        charInfo.dataValues.twoVtwoRating
      }**__`.length;
    ...
    if (charInfo.dataValues.threeVthreeRating != null) {
      let n = `\n\n__3v3:${noBreakSpace.repeat()}**${
        charInfo.dataValues.threeVthreeRating
      }**__`.length;
    ...
    if (
      charInfo.dataValues.soloShuffleSpec1Rating != null &&
      charInfo.dataValues.soloShuffleSpec1Rating != undefined
    ) {
      let n = `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][0]
      }:${noBreakSpace.repeat()}**${
        charInfo.dataValues.soloShuffleSpec1Rating
      }**__`.length;
      description += `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][0]
    ...
    if (
      charInfo.dataValues.soloShuffleSpec2Rating != null &&
      charInfo.dataValues.soloShuffleSpec2Rating != undefined
    ) {
      let n = `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][1]
      }:${noBreakSpace.repeat()}**${
        charInfo.dataValues.soloShuffleSpec2Rating
      }**__`.length;
      description += `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][1]
      }:${noBreakSpace.repeat(maxLengt - n)}**${
    ...
    if (
      charInfo.dataValues.soloShuffleSpec3Rating != null &&
      charInfo.dataValues.soloShuffleSpec3Rating != undefined
    ) {
      let n = `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][2]
      }:${noBreakSpace.repeat()}**${
        charInfo.dataValues.soloShuffleSpec3Rating
      }**__`.length;
      description += `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][2]
      }:${noBreakSpace.repeat(maxLengt - n)}**${
    ...
    if (
      charInfo.dataValues.soloShuffleSpec4Rating != null &&
      charInfo.dataValues.soloShuffleSpec4Rating != undefined
    ) {
      let n = `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][3]
      }:${noBreakSpace.repeat()}**${
        charInfo.dataValues.soloShuffleSpec4Rating
      }**__`.length;
      description += `\n\n__Shuffle ${
        classes[charInfo.dataValues.characterClass][3]
      }:${noBreakSpace.repeat(maxLengt - n)}**${
  ...
  await submissionChannel.send({
    embeds: [waitingForReviewEmbed],
    components: [waitingForReviewRow],
  });
...
async function createValWaitingForReviewMessage(
  interaction,
  charInfo,
  verifiedAccount,
  improvementInput,
...
module.exports = {
  ...
  createValWaitingForReviewMessage,
};

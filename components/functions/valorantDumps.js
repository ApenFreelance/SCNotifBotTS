        ...
        if(videoAmountFound != videosGettingPosted) {
          ...
          for(const tag in breakdown) {
              ...
              let videoEmbed = new EmbedBuilder()
                  ...
                  .setAuthor({ name: `A new Skill-Capped video has been released!`, iconURL: "https://media.discordapp.net/attachments/1065568610132697159/1110677308555137054/Skillcapped_Logo.jpg?width=585&height=585"})
